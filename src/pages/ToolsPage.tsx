...
export default function ToolsPage() {
  ...
  return (
    <div className="space-y-8">
      ...
      >
        <div className="absolute inset-0 bg-[radial-gradient(circle_at_20%_10%,rgba(16,185,129,0.16),transparent_45%),radial-gradient(circle_at_78%_18%,rgba(6,182,212,0.12),transparent_44%)] pointer-events-none" />
        ...
        <div className="relative space-y-5">
          <div className="inline-flex items-center rounded-full border border-primary/40 bg-primary/15 px-3 py-1 text-xs font-semibold uppercase tracking-[0.2em] text-primary">
            Security Tool Domains
          </div>

          <div className="max-w-3xl space-y-3">
            <h1 className="text-3xl sm:text-4xl lg:text-5xl font-semibold leading-tight">
              Tool Navigation by Security Function
            </h1>
            <p className="text-muted-foreground text-base sm:text-lg">
              Browse SOC, network, application, and utility stacks with explicit processing-mode labels for safer handling of sensitive data.
            </p>
          </div>
